...
namespace CenturyGame.SDFTool
{
    ...
    public class MeshToSDFBaker : IDisposable
    {
        ...
        void Init()
        {
            ...
            m_computeShader = Resources.Load<ComputeShader>("Shaders/SDFBaker/GenSdfRayMap");//m_RuntimeResources.sdfRayMapCS;
            ...
            if (m_Material == null || m_Material[0] == null || m_Material[1] == null || m_Material[2] == null)
            {
                ...
                Shader rayMapShader = Resources.Load<Shader>("Shaders/SDFBaker/RayMapVoxelize");
